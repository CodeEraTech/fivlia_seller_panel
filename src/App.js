...
function SellerTypeRoute({ element, foodOnly }) {
  ...
  if (foodOnly === false && isFoodSeller)
    return <Navigate to="/food-category" replace />;
...
function App() {
  ...
  useEffect(() => {
    ...
    socketRef.current.emit("joinSeller", { storeId: sellerId });

    socketRef.current.on("newInstruction", (data) => {
    ...
    <>
      ...
      <Routes>
        ...
        <Route
          path="/storecat"
          element={
            <SellerTypeRoute foodOnly={false} element={<StoreCategories />} />
          }
        />
        <Route
          path="/food-category"
          element={<SellerTypeRoute foodOnly element={<FoodCategory />} />}
        />
        <Route
          path="/add-food-category"
          element={
            <SellerTypeRoute foodOnly element={<AddStoreFoodCategory />} />
          }
        />
        <Route
          path="/sellerProduct"
          element={<PrivateRoute element={<SellerProduct />} />}
        />
        <Route
          path="/add-seller-product"
          element={<PrivateRoute element={<AddSellerProduct />} />}
        />
        ...
        <Route
          path="/addstorecat"
          element={
            <SellerTypeRoute foodOnly={false} element={<AddStoreCat />} />
          }
        />
        <Route
          path="/store-orders"
          element={<PrivateRoute element={<StoreOrder />} />}
        />
        <Route
          path="/search-products"
          element={<PrivateRoute element={<SearchProduct />} />}
        />
        <Route
          path="/unapproved-products"
          element={<PrivateRoute element={<UnapprovedProducts />} />}
        />
      ...
      {instruction && (
        <InstructionPopup
          data={instruction}
          onOk={() => {
            socketRef.current.emit("instructionRead", {
